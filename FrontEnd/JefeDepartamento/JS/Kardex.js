    ...
    filtradas.forEach(m => {
        ...
        tbody.innerHTML += `
            <tr>
                ...
                <td>${m.creditos}</td>
                <td><span style="background:#eef2f8; color:#0b2a4a; padding:4px 8px; border-radius:6px; font-weight:bold; font-size:12px;">${m.unidad || 6}</span></td>
...
function limpiar(){
    ...
    document.getElementById("unidadesMateria").value = "6";
...
window.guardarMateria = async function() {
    ...
    const unidades = document.getElementById("unidadesMateria").value;
...
window.editar = function(id) {
    ...
    document.getElementById("unidadesMateria").value = m.unidad || 6;
